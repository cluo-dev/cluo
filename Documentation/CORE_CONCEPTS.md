...
cluo is a stream processing library, with Airflow-like control flow construction syntax. It makes it easy to build composable stream processing pipelines, complete with branching, conditional logic, useful data transformation stages, etc.
